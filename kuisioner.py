...
import pandas as pd
from scipy.stats import beta, pearsonr, kstest
import numpy as np
...
if data_kuisioner is not None and data_pertanyaan is not None:
    ...
    # r_tabel untuk n=52, α=0.05
    n = len(data_kuisioner)
    alpha = 0.05
    r_tabel = beta.ppf(1 - alpha / 2, (n - 2) / 2, (n - 2) / 2)
    ...
    def uji_validitas(data, variable_group):
        ...
        for item_col in item_cols:
            ...
            r_hitung, p_value = pearsonr(data[item_col], skor_total)
